...
@section('dashboard-admin-content')
    ...
    <div class="card">
        <div class="card-body">
            ...
            <form action="{{ route('submit change user') }}" method="POST">
                {{ csrf_field() }}

                <div class="form-group row">
                    <label for="username" class="col-sm-2 col-form-label">Username</label>
                    <div class="col-sm-8">
                        <input type="text" class="form-control" id="username" value="{{ $admin_data[0]->username }}"
            ...
            <form action="{{ route('submit change password') }}" method="POST">
                ...
                <div class="form-group row">
                    ...
                    <div class="checkbox col-md-2" style="margin-top:0.6%;">
                        <label>
                            <input type="checkbox" style="width: 0.9rem; height: 0.9rem;" class="form-check-input"
                                id="check2" runat="server"> Show Password
                        </label>
                    </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="checkbox col-md-2" style="margin-top:0.6%;">
                        <label>
                            <input type="checkbox" style="width: 0.9rem; height: 0.9rem;" class="form-check-input"
                                id="check3" runat="server"> Show Password
                        </label>
                    </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="checkbox col-md-2" style="margin-top:0.6%;">
                        <label>
                            <input type="checkbox" style="width: 0.9rem; height: 0.9rem;" class="form-check-input"
                                id="check4" runat="server"> Show Password
                        </label>
                    </div>
