            ...
            @foreach ($pending_data as $key => $data)
                <div class="card mb-3">
                    ...
                    <div class="card-body">
                        ...
                        <a style="margin-left:10px;" class="btn btn-danger float-right"
                            href="{{ route('decline request', $data->auto_id) }}">Decline</a>
                        <a class="btn btn-primary float-right"
                            href="{{ route('accept request', $data->auto_id) }}">Accept</a>
