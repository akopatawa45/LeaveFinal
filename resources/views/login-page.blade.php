    ...
    <body>
        ...
        <div class="inner-wrapper login-body">
            <div class="login-wrapper">
                <div class="container">
                    <div class="loginbox grow shadow-sm">
                        <div class="login-left">
                            <img class="img-fluid" src="/assets/img/logo-hr.png" style="border-radius: 15%;"
                                ...
                                @if ($errors->any())
                                    @foreach ($errors->all() as $error)
                                        <div id="errorBox" style="text-align:center;margin-top:20px;"
                                            class="alert alert-danger col-md-12 alert-dismissible fade show"
                                            role="alert">
...
<input type="radio" name="login_type" id="login_type_admin" value="admin">
                ...
                <input type="radio" name="login_type" id="login_type_staff" value="staff">
                                    ...
                                    <div class="form-group">
                                        <button class="btn btn-theme button-1 ctm-border-radius btn-block text-white"
                                            type="submit" value="Login">Login</button>
                                    </div>
                                </form>

                                <div class="forgotpass text-center"><a href="forgot-password.html">Forgot Password?</a>
                                </div>
                                <div class="login-or">
